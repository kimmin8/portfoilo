$(document).ready(function(){
    ...
    $('.more1').click(function(){
        ...
        $('article li').eq(0).css({'display':'block'})
        $('article li').eq(1).css({'display':'none'})
        $('article li').eq(2).css({'display':'none'})

    })
    $('.more2').click(function(){
        $('article').css({'display':'block'})
        $('article li').eq(0).css({'display':'none'})
        $('article li').eq(1).css({'display':'block'})
        $('article li').eq(2).css({'display':'none'})
    ...
    $('.more3').click(function(){
        ...
        $('article li').eq(0).css({'display':'none'})
        $('article li').eq(1).css({'display':'none'})
        $('article li').eq(2).css({'display':'block'})
    ...
    $('.mainnav p').eq(0).click(function(){
        ...
        if($('.profile').hasClass('on')) {
            ...
            setTimeout(function(){
                $('.profile>.inner>div').eq(0).addClass('on')
                $('.profile>.inner>div').eq(1).addClass('on')
            },2000)
            setTimeout(function(){
                $('.profile>.inner>div').eq(0).find('li').addClass('on')
            },2500)

            // 스킬 숙련도
            let targets = [80, 80, 80, 80, 55];
            let speed = 45;

            function countUpAll() {
                $('.profile>.inner>div ul li').each(function(index){
                    let count = 0;
